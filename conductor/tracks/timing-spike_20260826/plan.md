...
- [ ] Task: Modelo de tiempo musical
  ...
  - [ ] Implementación (Green): tipos de tiempo musical y conversión a tiempo de host
  - [ ] Refactor y verificar cobertura ≥80%
- [ ] Task: Scheduler look-ahead
  ...
  - [ ] Marcar las funciones de tiempo real con `/// Realtime:`
  - [ ] Refactor y verificar cobertura
