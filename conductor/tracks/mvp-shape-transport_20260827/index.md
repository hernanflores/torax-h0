...
Ningún parámetro generativo es editable todavía. No es un recorte: es el estado «sin controlador conectado» que `product-guidelines.md` ya especifica — solo lectura y transporte. La entrada de control es el track siguiente.
