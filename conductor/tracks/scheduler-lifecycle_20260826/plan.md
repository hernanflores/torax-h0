...
> **El trabajo vive en la rama `fix/scheduler-lifecycle`, sin integrar.** Los
> SHAs que aparecen abajo son de esa rama. Se conserva como registro de la
> investigación: la carrera está resuelta ahí y los tests lo demuestran, pero la
> rama no es mergeable mientras empeore la tasa de `-50`.
