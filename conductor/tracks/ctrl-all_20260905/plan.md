...
- [x] Task: [step 14] mantiene y suelta (FR1, FR12, FR14) — `4aa708c`
  ...
  - [x] Implementación (Green): `ctrlAllModifierIndex = ControlMapping.controlsPerFamily - 3`
        ...
        selección.
- [x] Task: Con Ctrl All hundido, Ctrl All manda (FR10) — `431af56`
  - [x] Tests (Red): step buttons 1–12 no cambian de Track; los modificadores 15 y
        16 no publican gesto de mezcla; el knob del Cycle no lo mueve; los
        dieciséis pads no tocan el pool.
  - [x] Tests (Red): los knobs de parámetro **sí** responden, y son los únicos.
